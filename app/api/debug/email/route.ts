...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        const { success, error } = await sendEmail({
            ...
            html: en
                ? `<h1>This is a technical test.</h1><p>If you receive this, the SMTP email configuration is working on Vercel.</p>`
                : `<h1>Ceci est un test technique.</h1><p>Si vous recevez ceci, la configuration Email SMTP fonctionne sur Vercel.</p>`
        });
