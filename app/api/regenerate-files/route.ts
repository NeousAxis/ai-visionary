...
export async function POST(req: NextRequest) {
    ...
    <div style="background: linear-gradient(135deg, #212E53 0%, #4A919E 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
        ...
        <p style="color: #BED3C3; margin: 10px 0 0; font-size: 14px;">Suite a la mise a jour de vos donnees</p>
    </div>

    <div style="background: #fff; padding: 25px; border: 1px solid #e5e7eb;">
        <p>Bonjour,</p>
        <p>Suite a la mise a jour de vos informations pour <strong>${entityName}</strong>, nous avons regenere vos fichiers ASR.</p>
        ...
        <div style="background: #f9fafb; padding: 15px; border-radius: 8px; border: 1px solid #e5e7eb;">
            <h3 style="margin-top: 0; color: #212E53;">Fichiers regeneres</h3>
    ...
    <div style="background: #f9fafb; padding: 15px; border-radius: 0 0 12px 12px; text-align: center; border: 1px solid #e5e7eb; border-top: 0;">
        ...
        const emailResult = await resend.emails.send({
            ...
            to: [customerEmail],
            subject: `Vos fichiers AYO mis a jour — ${entityName}`,
