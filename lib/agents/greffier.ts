...
// --- ENRICHMENT TEMPLATES (STATIQUES — remplace le LLM pour les questions d'enrichissement) ---

const ENRICHMENT_TEMPLATES: Record<string, {text: string, options?: string[], inputType?: string, customLabel?: string, allowMultiple?: boolean}> = {
    // Identité
