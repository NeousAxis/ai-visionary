...
const CONFORMITE_TEMPLATES: EvidenceQuestion[] = [
  tmpl('engagements_conformite', 'certifications', {
    question_fr: "Avez-vous une page sur votre site qui explique comment vous protegez les donnees de vos clients ?",
    question_en: "Do you have a page on your website that explains how you protect your clients' data?",
    evidenceType: 'url',
    priority: 30,
    reliabilityLevel: 'verifiable',
    customLabel_fr: "Lien protection donnees...",
  ...
  tmpl('engagements_conformite', 'policies', {
    ...
    question_en: "Do you have a page on your website that explains how you work with clients (your process or steps)?",
    evidenceType: 'url',
    priority: 32,
    reliabilityLevel: 'verifiable',
    customLabel_fr: "Lien methode de travail...",
    customLabel_en: "Process page link...",
  }),
  tmpl('engagements_conformite', 'security_measures', {
    question_fr: "Avez-vous une page qui liste clairement vos services ou ce que vous proposez ?",
    question_en: "Do you have a page that clearly lists your services or what you offer?",
    evidenceType: 'url',
    priority: 33,
    reliabilityLevel: 'verifiable',
    customLabel_fr: "Lien page services...",
    customLabel_en: "Services page link...",
  }),
];
